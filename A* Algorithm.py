...
def algorithm_final(): # Initialising all variables for the initial visualisation
    ...
    start_node_X = pygame.image.load('startnodex.png')
    start_node_Y = pygame.image.load('startnodey.png')
    end_node_X = pygame.image.load('endnodex.png')
    end_node_Y = pygame.image.load('endnodey.png')
...
def intro_screen():
    ...
    algoImg = pygame.image.load('algorithm.png')
    lineImg = pygame.image.load('Blackline.png')
    lineImg2 = pygame.image.load('Blackline.png')
    horizontalLine = pygame.image.load('Line2.png')
    MazeImg = pygame.image.load('Maze.png')
    NavImg1 = pygame.image.load('Nav7.png')
